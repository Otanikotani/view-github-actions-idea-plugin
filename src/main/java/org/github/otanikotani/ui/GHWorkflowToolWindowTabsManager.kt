...
@Service
internal class GHWorkflowToolWindowTabsManager(private val project: Project) {
  ...
  companion object {
    ...
    private fun updateRemotes(project: Project) = project.service<GHWorkflowToolWindowTabsManager>().updateRemoteUrls()
  }
}
