...
//import org.jetbrains.plugins.github.pullrequest.ui.toolwindow.*
...
//
//internal class GitHubWorkflowToolWindowTabControllerImpl(private val project: Project,
...
//                                                         private val tab: Content) : GitHubWorkflowToolWindowTabController {
...
//                val pullRequestComponent = GHPRViewComponentFactory(
//                    ActionManager.getInstance(), project, dataContext, this, id,
//                    currentDisposable!!)
//                    .create()
