...
import org.github.otanikotani.workflow.GitHubWorkflowRunListSelectionHolder
...
internal class GitHubWorkflowToolWindowTabControllerImpl(
    ...
    private fun createContent(
        ...
        val logLoadingPanel = GHLoadingPanelFactory(logLoadingModel,
            "Can't load data from GitHub",
            GithubBundle.message("cannot.load.data.from.github"),
            errorHandler).create { parent, result ->
