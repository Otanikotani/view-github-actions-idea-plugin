...
//
//open class GithubWorkflowOpenInBrowserActionGroup : ActionGroup("Open on GitHub", "Open corresponding link in browser", AllIcons.Vcs.Vendors.Github), DumbAware {
//
...
//
//        return getDataFromWorkflow(project, dataContext)
//            ?: getDataFromHistory(project, dataContext)
//            ?: getDataFromLog(project, dataContext)
//            ?: getDataFromVirtualFile(project, dataContext)
//    }
//
//    private fun getDataFromWorkflow(project: Project, dataContext: DataContext): Pair<Set<GHRepositoryCoordinates>, Data>? {
//        val workflow = dataContext.getData(GitHubWorkflowRunActionKeys.SELECTED_WORKFLOW_RUN) ?: return null
//        val context = dataContext.getData(GitHubWorkflowRunActionKeys.ACTION_DATA_CONTEXT) ?: return null
//
//        return setOf(context.repositoryCoordinates) to Data.URL(project, workflow.url)
//    }
//
