...
public class OpenMainPanel extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        executorService.execute(() -> checkSuiteService.run(checksResult -> {
            checksDialogWrapper.setName(checksResult.getName());
            checksDialogWrapper.setStatus(checksResult.getStatus());
            checksDialogWrapper.setStartedAt(checksResult.getStartedAt());
